...
var file_buf_validate_conformance_cases_custom_rules_custom_rules_proto_goTypes = []any{
	...
	(*DynRuntimeError)(nil),                     // 4: buf.validate.conformance.cases.custom_rules.DynRuntimeError
	(*NowEqualsNow)(nil),                        // 5: buf.validate.conformance.cases.custom_rules.NowEqualsNow
	(*FieldExpressionOnly)(nil),                 // 6: buf.validate.conformance.cases.custom_rules.FieldExpressionOnly
